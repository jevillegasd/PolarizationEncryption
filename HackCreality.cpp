...
const std::wstring DEFAULT_CTB_INP_FILENAME(PATH + L"\\models\\box\\dslab.ctb");
const std::wstring DEFAULT_CTB_OUT_FILENAME(PATH + L"\\models\\box\\dslab.ctb");
...
void messageParser(int* option) {
    ...
    case 7: {
        *option = 0;
        wstring file_name = PATH + L"\\src_py\\t_img_2560_mono.bmp";
