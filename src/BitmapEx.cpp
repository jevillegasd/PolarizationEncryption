...
void CBitmapEx::Load(const char * lpszBitmapFile)
{
	// Check for valid .BMP file path
	if (lpszBitmapFile != NULL)
	{
		// Open .BMP file
		FILE* file = fopen(lpszBitmapFile, "rb");
		if (file != NULL)
		{
...
//void CBitmapEx::Load(const WCHAR* lpszBitmapFile)
//{
//	// Check for valid .BMP file path
//	if (lpszBitmapFile != NULL)
//	{
...
void CBitmapEx::Save(const char * lpszBitmapFile)
{
	// Check for valid .BMP file path
	if (lpszBitmapFile != NULL)
	{
		...
		printf("/t File open success (output) ...\n");
		if (file != NULL)
		{
...
//void CBitmapEx::Save(const WCHAR * lpszBitmapFile)
//{
//	// Check for valid .BMP file path
//	if (lpszBitmapFile != NULL)
//	{
...
void CBitmapEx::_RotateNearestNeighbour(long degrees, _PIXEL bgColor)
{
	...
	if (IsValid())
	{
		...
		long _width = (long)(abs((long)((float)m_bih.biWidth * cos(_angle))) + abs((long)((float)m_bih.biHeight * sin(_angle))) + 0.5f);
		long _height = (long)(abs((long)((float)m_bih.biWidth * sin(_angle))) + abs((long)((float)m_bih.biHeight * cos(_angle))) + 0.5f);
		long _pitch = m_iBpp * _width;
		while ((_pitch & 3) != 0)
			_pitch++;
